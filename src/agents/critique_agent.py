...
***STORY AGENT INSTRUCTIONS***
    ...
    * Only compare them and show the analysis. Do not decide which option should be used.
...
Consider the following remaining responses:
{context.agent_responses[Agent.ReflectAgent]}
...
"""
	...
	def get_agent_response(self, context: AgentContextModel) -> str:
		...
		context.agent_responses[Agent.CritiqueAgent] = response
